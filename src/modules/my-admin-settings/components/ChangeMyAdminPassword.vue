                  ...
                  <div class="col-12">
                    ...
                    <div class="input-group">
                      <input
                        ...
                        required
                      />
                      <span class="input-group-text" id="currentPasswordEye" @click="currentPasswordIsVisible = !currentPasswordIsVisible" style="cursor: pointer; background-color: transparent">
