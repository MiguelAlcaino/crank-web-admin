...
export type ClassPackagesQuery = { __typename: 'Query', products: Array<
    | { __typename: 'ClassPackageProduct', id: string, title: string, subtitle?: string | null, buttonText?: string | null, currency: string, type?: ClassPackageTypeEnum | null, isVisible: boolean, position?: number | null, isMembership?: boolean | null, isTrialPackage?: boolean | null, isCLassPassPackage?: boolean | null, doesItRequireSmsAuth?: boolean | null, doestItActivateVodForClients?: boolean | null, vodAmountOfDays?: number | null, alertBeforePurchasing?: { __typename: 'ProductAlertBeforePurchasing', title: string, description: string } | null, variants: Array<{ __typename: 'Variant', price: number }> }
    | { __typename: 'GiftCard' }
  > };
